...
namespace AutoUsing.Lsp
{
    ...
    class CompletionInstance
    {
        ...
        public static Task<CompletionList> ProvideCompletionItems(CompletionParams request)
        {
            ...
            var completionInstance = new CompletionInstance(documentWalker, projectName, wordToComplete);
        ...
        public CompletionInstance(DocumentWalker documentWalker, string projectName, string wordToComplete)
        {
